...
The full SoC top-level integrates modules from multiple external repositories (CPU, crossbar, MMU, cache, DMA, IOMMU, PLIC). Full-top synthesis was not attempted due to host memory constraints (16 GB). The table below covers the SoC-local glue modules defined in this repo; see each sub-component repository for its own synthesis results.

| Module | LUTs | FFs | BRAM | DSP | Fmax (MHz) |
|--------|------|-----|------|-----|------------|
| **axi_sram** (16K words) | 18,142 | 100 | 0 | 0 | 238.9 |
| axi_periph_bridge | 55 | 110 | 0 | 0 | 402.3 |
| plic (SoC wrapper) | 87 | 35 | 0 | 0 | N/A (combinational) |
| riscv_soc_top (full) | — | — | — | — | Not attempted (multi-repo) |

*Auto-generated by Vivado batch synthesis. Clock target: 100 MHz. The axi_sram uses distributed RAM (LUTs) at default depth — BRAM inference would reduce LUT count significantly.*
